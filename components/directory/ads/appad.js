...
import NewImage from '../public/images/iphone_portrait.png'
import classes from '../utils/classes';



export default function YpAppSection() {
...
<div className="p-1 w-full text-center bg-gray-50 opacity-75  sm:p-8 dark:bg-gray-100 ">
<h5 className="mb-2 text-3xl font-bold text-gray-800 ">Work fast from anywhere</h5>
