...
const footerNav = {
  Services: [
    ...
    { title: "BornoyellowPages ", href: "/#" },
    { title: "Store ", href: "/product" },
...
export default function Footer(){
  return (
    <footer className="bg-neutral-900 border-t border-neutral-800">
      <div className="mx-auto max-w-screen-3xl px-4 pt-16 sm:px-8">
        <div className="grid grid-cols-2 gap-y-6 gap-x-6 md:!grid-cols-6 md:gap-8 xs:grid-cols-2">
          <div className="mb-4  flex flex-col xs:col-span-2 text-gray-300">
            <span className="text-lg font-bold capitalize">
              BornoYellowPages
              <div className="mt-">
                    <span className="inline-block w-20 h-1 bg-yellow-400 rounded-full"></span>
          ...
          {Object.entries(footerNav).map(([title, items]) => {
            return (
              <div key={title}>
                <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 hover:underline decoration-yellow-300 ">
                  {title}
                </h2>
          ...
          <div className="flex flex-col space-y-2">
            ...
            <a href="#">
              <img
                src="/images/app_gallery_download_button.svg"
                alt="download app"
                className="h-12"
              />
            </a>
        ...
        >
          <p className="text-center text-sm dark:text-gray-300">
            ...
            <a
              ...
              className="font-semibold text-gray-300 hover:text-gray-300 hover:underline "
            >
              Borno Yellow Pages
            </a>
          </p>
