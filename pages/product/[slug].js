...
export default function ProductScreen(props) {
  ...
  return (
    <Layout title={product.name}>
     ...
     <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4 bg-neutral-900">
            <div className="xl:w-2/6 lg:w-2/5 w-80 md:block hidden">
                <img passHref className="w-full" alt="img of a girl posing" src={product.image} />
                <img passHref className="mt-6 w-full" alt="img of a girl posing" src="https://i.ibb.co/qxkRXSq/component-image-two.png" />
            </div>
            <div className="md:hidden">
                <img passHref className="w-full" alt="img of a girl posing" src="https://i.ibb.co/QMdWfzX/component-image-one.png" />
                <div className="flex items-center justify-between mt-3 space-x-4 md:space-x-0">
                    <img passHref alt="img-tag-one" className="md:w-48 md:h-48 w-full" src="https://i.ibb.co/cYDrVGh/Rectangle-245.png" />
                    <img passHref alt="img-tag-one" className="md:w-48 md:h-48 w-full" src="https://i.ibb.co/f17NXrW/Rectangle-244.png" />
                    <img passHref alt="img-tag-one" className="md:w-48 md:h-48 w-full" src="https://i.ibb.co/cYDrVGh/Rectangle-245.png" />
                    <img passHref alt="img-tag-one" className="md:w-48 md:h-48 w-full" src="https://i.ibb.co/f17NXrW/Rectangle-244.png" />
                </div>
            </div>
            <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
                ...
                <div>
                    <div className="border-b py-4 border-gray-200">
                        ...
                        <p className="text-base leading-4 text-gray-600">Colours</p>
                ...
                <div>
                    <div className="border-b py-4 border-gray-200">
                        ...
                        <p className="text-base leading-4 text-gray-600">Sizes</p>
                    <div className="flex items-center justify-center">
                    <p className="text-sm leading-none text-gray-600 mr-3">38.2</p>
                        ...
                        <div className={"pt-4 text-base leading-normal pr-12 mt-4 text-gray-600 " + (show4 ? "block" : "hidden")} id="sect">
                            If you have any questions on how to return your item to us, contact us.
                        </div>
                    </div>
                </div>
...
<Button className="" handleClick={addToCartHandler}>
          <svg
            width="21"
            height="22"
