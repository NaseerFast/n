...
import JobsToday from '../../components/jobportal/JobsToday';
...
export default function JobPortal({ joblistings}){
...
const submitHandler = (e) => {
  ...
  <div className="overflow-hidden" style={{background: "url(images/grad-10.jpg)", backgroundSize: 'cover'}}>
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-neutral-900 md:text-5xl lg:text-6xl ">Find a job that matches your skill and interest</h1>
        <p className="mb-8 text-lg font-normal text-neutral-900 lg:text-xl sm:px-16 xl:px-48 ">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
        <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4 text-red-300">
           
            <a href="#" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg  bg-white text-neutral-900 hover:text-neutral-800 focus:ring-4 focus:ring-gray-100 ">
     ...
     {/* <section className="bg-neutral-900">
     <div className="  rounded-md overflow-hidden bg-cover bg-center" style={{ backgroundImage: `url('/images/grad-10.jpg')` }}>
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">

        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Find a job that matches your skills and interest </h1>
        <p className="mb-8 text-lg font-normal text-gray-800 lg:text-xl sm:px-16 xl:px-48 ">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
        <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4 text-red-300">
            <a href="#" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white  rounded-lg hover:bg-primary-0 focus:ring-4 focus:ring-primary-300 hover:text-white ">
                Learn more
                <svg className="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
            </a>
            <a href="#" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg border border-gray-300 hover:bg-yellow-300 hover:text-neutral-900 focus:ring-4 focus:ring-gray-100 ">
                <svg className="mr-2 -ml-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 6a2 2 0 012-2h6a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V6zM14.553 7.106A1 1 0 0014 8v4a1 1 0 00.553.894l2 1A1 1 0 0018 13V7a1 1 0 00-1.447-.894l-2 1z"></path></svg>
                Find a Job
            </a>
        </div>
...
<section className="bg-neutral-900 sm:pl-12">
<div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
        <header>
        <div className=" mx-auto bg-neutral-900 pb-8 px-2">
            ...
            <form onSubmit={submitHandler}>
                <input className="w-full border rounded-md pl-10 pr-4 py-2 bg-neutral-800 border border-gray-600 focus:border-black focus:outline-black focus:shadow-outline text-white" type="text" placeholder="Search" name="name" onChange={queryChangeHandler} />
                </form>
            </div>
...
<p className="font-semibold text-gray-400 uppercase text-center pb-6 md:text-xl">Find by category</p>
...
<div className="grid grid-cols-5  gap-4">
  ...
  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-4 lg:gap-8">
      ...
      {categories.map((item, index) => (
        <NextLink key={index} href={`/jobs/search?category=${item.category}`} passHref  >
  <div  className="py-8 bg-neutral-800 rounded-md flex items-center justify-center cursor-pointer">
<div  className="flex flex-col items-center ">
<img  className="mb-3 w-12 h-12  " src="/images/1.png" alt="Bonnie image"/>
<h5 className="mb-1  font-medium text-gray-900 dark:text-white text-xs md:text-sm text-center">{item.category}</h5>
<span className="text-xs text-gray-500 dark:text-gray-400">40+ jobs </span>
  ...
  {/* <div className="bg-red-100 sm:mx-4"></div> */}
</div>

</div>
</section>

<div className="md:px-4 py-8 bg-neutral-900 border border-gray-800">
<p className="font-semibold text-gray-400 uppercase text-center pt-8 mb-8 md:text-xl">Latest Jobs</p>
<Box sx={isDesktop ? classes.visible : classes.hidden}>
  <MyTabs joblistings={joblistings} />
  </Box>

  <Box sx={isDesktop ? classes.hidden : classes.visible}>
  <JobsToday joblistings={joblistings} />
  </Box>
{/* <p className="text-red-500 text-center border border-red-300 inline-block">Find all Jobs</p> */}
<div className='flex items-center justify-center my-16'>

<NextLink href="/jobs/search" className="  " passHref>
  <p  className="font-semibold text-white hover:text-neutral-900 font-medium hover:bg-yellow-300 py-2 px-4 border border-gray-400   rounded-sm cursor-pointer">Search All Jobs </p>
</NextLink>
</div>
</div>
...
export async function getServerSideProps() {
  ...
  const joblistings = await JobListing.find().lean();
  return {
    props: {
      joblistings: joblistings.map(db.convertDocToObj),
    },
  };
}
