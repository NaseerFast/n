...
const NewHero = () => {
  return (
    ...
    >
      {/* <!-- Left item --> */}
      <div className="flex flex-col mt-12 mb-32 space-y-12 md:w-1/2">
        <h1
        ...
        <ul className="max-w-lg space-y-4 text-neutral-800 list-inside ">
            <li className="flex items-center"> <svg className="flex-shrink-0 w-7 h-6 text-gray-800 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"></path></svg> Look no further than Yellow Pages Digital Enterprise!</li>
            <li className="flex items-center"> <svg className="flex-shrink-0 w-7 h-6 text-gray-800 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"></path></svg>Our online platform makes it easy to list your business and get noticed by customers searching for your products or services.</li>
            <li className="flex items-center"> <svg className="flex-shrink-0 w-7 h-6 text-gray-800 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"></path></svg>For an even more widespread reach, consider adding one of out outdoor billboards to your marketing mix!</li>
        </ul>
        <div className="flex justify-center md:justify-start">
          <a
            href="#"
            className="p-3 px-6 pt-2 text-gray-800 bg-yellow-400 rounded-full baseline bg-brightRedLight"
            >Get Started</a
          >
        </div>
      </div>
