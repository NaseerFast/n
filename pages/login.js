      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="bg-neutral-800 border border-gray-700 rounded  focus:ring-neutral-700 text-xs font-medium leading-none text-gray-400 py-3 w-full pl-3 mt-2"
            id="email"
            autoFocus
          ></input>
          {errors.email && (
        ...
        <div className="mb-4 ">
          <button className="focus:ring-neutral-700 text-sm font-semibold leading-none text-white focus:outline-none bg-neutral-900 border border-gray-700  rounded hover:bg-yellow-300 py-4 w-full">Login</button>
        </div>
